...
// // @title Tokokecil Product API
// // @version 1.0
// // @description Microservice Product - Hanya Product, Auth & User dihandle oleh Auth Service terpisah
// // @termsOfService http://swagger.io/terms/

// // @contact.name Tokokecil Support
// // @contact.url http://tokokecil.support.local
// // @contact.email support@tokokecil.local
