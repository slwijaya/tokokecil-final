...
type ProductServiceClient interface {
	GetAllProducts(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProductListResponse, error)
...
func (c *productServiceClient) GetAllProducts(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProductListResponse, error) {
...
type ProductServiceServer interface {
	GetAllProducts(context.Context, *Empty) (*ProductListResponse, error)
...
func (UnimplementedProductServiceServer) GetAllProducts(context.Context, *Empty) (*ProductListResponse, error) {
